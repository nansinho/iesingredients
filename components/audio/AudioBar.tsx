...
export function AudioBar() {
  ...
  return (
    <>
      ...
      {/* Fixed audio bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 h-[72px] bg-white/95 dark:bg-dark/95 backdrop-blur-xl border-t border-brown/10 dark:border-white/10 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
        <div className="h-full max-w-[1400px] mx-auto px-4 sm:px-6 flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0 shrink-0 max-w-[120px] sm:max-w-[200px]">
            <p className="text-sm font-semibold text-dark dark:text-cream-light truncate leading-tight">
              {currentEpisode.title}
            </p>
            <p className="text-xs text-dark/40 dark:text-cream-light/40 truncate">
              À Fleur De Nez
            </p>
          </div>
          ...
          <div className="flex-1 flex items-center gap-2 min-w-0">
            <span className="text-[11px] text-dark/40 dark:text-cream-light/40 tabular-nums shrink-0 hidden sm:block">
              {formatTime(currentTime)}
            </span>
            <div className="flex-1 relative group">
              <div className="h-1.5 rounded-full bg-brown/10 dark:bg-white/10 overflow-hidden">
                <div
          ...
          <div className="hidden md:flex items-center gap-1.5">
            <button
              onClick={toggleMute}
              className="text-dark/40 dark:text-cream-light/40 hover:text-dark dark:hover:text-cream-light transition-colors"
            >
              {volume === 0 ? (
            ...
            <div className="relative w-20 group">
              <div className="h-1 rounded-full bg-brown/10 dark:bg-white/10 overflow-hidden">
                <div
                  className="h-full rounded-full bg-dark/20 dark:bg-cream-light/30"
          ...
          <button
            onClick={stop}
            className="text-dark/30 dark:text-cream-light/30 hover:text-dark dark:hover:text-cream-light transition-colors shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
