  ...
  return (
    <section className="py-12 md:py-20 bg-white">
      <div className="w-[94%] max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <p className="text-sm font-medium text-dark/40 uppercase tracking-wider mb-3">
          ...
          <div className="md:hidden relative">
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-dark/10 bg-white text-dark text-sm font-medium"
            >
              {activeLabel}
              <ChevronDown
                className={cn(
            ...
            <button
              ...
              className={cn(
                ...
                activeDepartment === "all"
                  ...
                  : "bg-white text-dark/60 border-dark/10 hover:border-[var(--brand-accent)]/40 hover:text-dark"
              )}
            >
            ...
            <div key={group.deptId}>
              ...
              {activeDepartment === "all" && (
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xs font-medium text-dark/30 bg-dark/5 px-2 py-0.5 rounded-full">
...
function TeamCard({
  ...
  return (
    <div className="group rounded-2xl overflow-hidden bg-white border border-dark/6 hover:border-[var(--brand-accent)]/20 hover:shadow-lg transition-all duration-300">
      {/* Photo */}
      <div className="p-2.5 pb-0">
        <div className="aspect-[4/3] relative overflow-hidden rounded-xl bg-cream">
          {member.photo_url ? (
            <Image
            ...
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[var(--brand-primary)]/10 to-[var(--brand-accent-light)]/20">
              <span className="text-4xl font-semibold text-[var(--brand-primary)]/25 select-none">
                {displayInitials}
              </span>
            </div>
          )}
      ...
      <div className="px-4 pt-3 pb-4">
        <h3 className="font-semibold text-base text-dark leading-tight">
          {member.name}
        </h3>
        ...
        {(member.email || member.phone) && (
          <div className="mt-3 pt-3 border-t border-dark/6 space-y-1.5">
            {member.email && (
              <a
                href={`mailto:${member.email}`}
                className="flex items-center gap-2 text-dark/50 hover:text-[var(--brand-accent)] transition-colors duration-200 text-xs"
              >
            ...
            {member.linkedin_url && (
              <a
                ...
                className="flex items-center gap-2 text-dark/50 hover:text-[#0A66C2] transition-colors duration-200 text-xs"
              >
