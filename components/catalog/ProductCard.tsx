  ...
  return (
    ...
    >
      <motion.article
        ...
        className="relative h-full rounded-2xl border border-brown/8 dark:border-brown/10 overflow-hidden bg-white dark:bg-dark-card hover:shadow-[0_20px_60px_rgba(196,116,131,0.1)] hover:border-brown/20 transition-all duration-500 flex flex-col"
      >
