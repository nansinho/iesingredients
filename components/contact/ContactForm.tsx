...
export function ContactForm() {
  ...
  return (
    <div>
      <h2 className="font-playfair italic text-3xl text-dark mb-2">
      ...
      {status === "success" && (
        <div className="mb-6 p-4 rounded-xl bg-olive/10 border border-olive/20 text-olive-dark">
      ...
      {fieldErrors._form && (
        <div className="mb-6 p-4 rounded-xl bg-peach/10 border border-peach/20 text-brown-dark">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="firstName" className="text-dark">{isFr ? "Prénom" : "First name"} *</Label>
            <Input
              id="firstName"
              name="firstName"
              ...
              required
              className="h-12 border-brown/15 bg-white focus:border-brown/30 rounded-xl"
              placeholder="Jean"
            />
          ...
          <div className="space-y-2">
            <Label htmlFor="lastName" className="text-dark">{isFr ? "Nom" : "Last name"} *</Label>
            <Input
              id="lastName"
              name="lastName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="phone" className="text-dark">{isFr ? "Téléphone" : "Phone"}</Label>
            <Input
              id="phone"
              name="phone"
              type="tel"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="company" className="text-dark">{isFr ? "Entreprise" : "Company"}</Label>
            <Input
              id="company"
              name="company"
          ...
          <div className="space-y-2">
            <Label htmlFor="subject" className="text-dark">{isFr ? "Sujet" : "Subject"} *</Label>
            <Input
              id="subject"
              name="subject"
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            required
            rows={6}
            className="resize-none border-brown/15 bg-white focus:border-brown/30 rounded-xl"
            placeholder={
              isFr
