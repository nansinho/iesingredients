            ...
            <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {members.map((member: any) => (
                <StaggerItem key={member.id}>
                  <HoverLift>
                    <div className="group rounded-2xl overflow-hidden bg-white dark:bg-dark-card border border-brown/8 dark:border-brown/10 hover:border-brown/20 hover:shadow-[0_20px_60px_rgba(196,116,131,0.1)] transition-all duration-500">
                      <div className="p-3">
