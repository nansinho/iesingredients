              ...
              {articles.map((article: any) => (
                <StaggerItem key={article.id}>
                  <HoverLift>
                    ...
                    >
                      <article className="bg-white dark:bg-dark-card rounded-2xl overflow-hidden border border-brown/8 dark:border-brown/10 hover:border-brown/20 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(163,123,104,0.1)]">
