      ...
      <section className="relative z-20 -mt-8">
        <div className="max-w-[1100px] w-[90%] mx-auto">
          <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <StaggerItem>
              <a href="tel:+33493000000" className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-dark-card border border-brown/8 dark:border-brown/10 shadow-[0_8px_30px_rgba(131,155,151,0.08)] hover:shadow-[0_12px_40px_rgba(131,155,151,0.14)] hover:-translate-y-0.5 transition-all duration-300 group">
                <div className="w-10 h-10 rounded-xl bg-peach/10 border border-peach/20 flex items-center justify-center shrink-0 group-hover:bg-peach/20 transition-all">
            ...
            <StaggerItem>
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-dark-card border border-brown/8 dark:border-brown/10 shadow-[0_8px_30px_rgba(131,155,151,0.08)] group">
      ...
      <section className="py-20 md:py-28 bg-white dark:bg-dark relative overflow-hidden">
        ...
        <div className="w-[94%] mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <AnimateIn delay={0.1} y={30} className="lg:col-span-3">
            <div className="bg-cream-light dark:bg-dark-card rounded-2xl p-6 sm:p-8 md:p-10 border border-brown/8 dark:border-brown/10 shadow-[0_8px_40px_rgba(131,155,151,0.06)]">
              <ContactForm />
            </div>
          </AnimateIn>
