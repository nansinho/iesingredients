  ...
  return (
    <>
          ...
          <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <StaggerItem>
              <a href="mailto:contact@ies-ingredients.com" className="flex items-center gap-3 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-[var(--color-cream)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_50px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-10 h-10 rounded-xl bg-[var(--brand-accent)]/10 border border-[var(--brand-accent)]/20 flex items-center justify-center shrink-0 group-hover:bg-[var(--brand-accent)]/20 transition-all">
                  <Mail className="w-4.5 h-4.5 text-[var(--brand-accent)]" />
                </div>
                <div className="min-w-0">
                  <p className="font-semibold text-[var(--color-charcoal)] text-sm">Email</p>
                  <p className="text-xs text-[var(--brand-primary)]/45 truncate">contact@ies-ingredients.com</p>
                </div>
              </a>
            </StaggerItem>
            <StaggerItem>
              <a href="tel:+33493000000" className="flex items-center gap-3 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-[var(--color-cream)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_50px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[var(--brand-primary)]/45">+33 4 93 00 00 00</p>
                </div>
              </a>
            </StaggerItem>
            <StaggerItem>
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-[var(--color-cream)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] group">
                <div className="w-10 h-10 rounded-xl bg-[var(--brand-accent)]/10 border border-[var(--brand-accent)]/20 flex items-center justify-center shrink-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[var(--brand-primary)]/45">Nice, France</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-[var(--color-cream)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] group">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[var(--brand-primary)]/45">{isFr ? "Lun - Ven : 9h - 18h" : "Mon - Fri: 9am - 6pm"}</p>
                </div>
              </div>
            </StaggerItem>
          </StaggerGrid>
      ...
      <section className="py-20 md:py-28 bg-white relative overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[var(--brand-accent)]/3 rounded-full blur-[180px]" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[var(--brand-accent-light)]/5 rounded-full blur-[120px]" />
            ...
            <div className="lg:sticky lg:top-28 space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-4 rounded-xl bg-[var(--color-cream-light)] border border-[var(--color-cream)]">
                  <CheckCircle2 className="w-5 h-5 text-[var(--brand-accent)] mt-0.5 shrink-0" />
                  <div>
                    <p className="font-medium text-[var(--color-charcoal)] text-sm">
                      {isFr ? "Échantillons gratuits" : "Free samples"}
                    </p>
                    <p className="text-xs text-[var(--brand-primary)]/45 mt-0.5">
              ...
              {/* Trust badge */}
              <div className="p-5 rounded-2xl bg-[var(--brand-accent)]/10 border border-[var(--brand-accent)]/15">
                ...
                <p className="text-[var(--brand-primary)]/45 text-xs leading-relaxed">
                  {isFr
