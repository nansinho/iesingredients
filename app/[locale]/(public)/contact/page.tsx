        ...
        <div className="max-w-[1400px] w-[90%] mx-auto relative z-10 text-center">
          ...
          <AnimateIn delay={0.1} y={30}>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-semibold text-cream-light tracking-[-0.03em] leading-[1.05] mb-6">
              ...
              <span className="font-playfair uppercase tracking-wide text-peach">{isFr ? "projets" : "projects"}</span>
            </h1>
          </AnimateIn>
          <AnimateIn delay={0.2}>
      ...
      <section className="relative z-20 -mt-8">
        <div className="max-w-[1100px] w-[90%] mx-auto">
          <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <StaggerItem>
              <a href="tel:+33493000000" className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-dark-card border border-brown/8 dark:border-brown/10 shadow-[0_8px_30px_rgba(163,123,104,0.08)] hover:shadow-[0_12px_40px_rgba(163,123,104,0.14)] hover:-translate-y-0.5 transition-all duration-300 group">
                <div className="w-10 h-10 rounded-xl bg-peach/10 border border-peach/20 flex items-center justify-center shrink-0 group-hover:bg-peach/20 transition-all">
            ...
            <StaggerItem>
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-dark-card border border-brown/8 dark:border-brown/10 shadow-[0_8px_30px_rgba(163,123,104,0.08)] group">
            ...
            <div className="lg:sticky lg:top-28 space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-dark dark:text-cream-light tracking-tight mb-2">
                  ...
                  <span className="font-playfair uppercase tracking-wide text-brown dark:text-peach">{isFr ? "contacter ?" : "contact us?"}</span>
                </h2>
