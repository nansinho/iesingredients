...
export function ProductDataTable({
  ...
  return (
    <div className="space-y-4">
      {/* Desktop table */}
      <div className="hidden md:block overflow-hidden rounded-xl border-0 bg-card">
        <Table>
          <TableHeader>
                ...
                <TableCell className="py-3">
                  {product.image_url ? (
                    <img
                      ...
                      alt=""
                      className="w-11 h-11 object-cover rounded-lg border-0"
                    />
                  ) : (
                    <div className="w-11 h-11 bg-muted rounded-lg flex items-center justify-center border-0">
      ...
      <div className="md:hidden space-y-3">
        {products.map((product) => (
          <div
            key={product.id}
            className="p-4 rounded-xl border-0 bg-card transition-all duration-200 hover:shadow-md cursor-pointer"
            onClick={(e) => handleRowClick(e, product.code)}
          >
            <div className="flex items-start gap-3">
              {product.image_url ? (
                <img
                  src={product.image_url}
                  alt=""
                  className="w-14 h-14 object-cover rounded-lg border-0 shrink-0"
                />
              ) : (
                <div className="w-14 h-14 bg-muted rounded-lg flex items-center justify-center shrink-0 border-0">
            ...
            <div className="flex items-center justify-end gap-2 mt-4 pt-3 border-t-0">
              {showPerformance && (
