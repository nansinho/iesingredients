    ...
    <footer ref={ref} className="bg-forest-950 text-white">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Categories */}
          <div>
            <h4 className="font-medium mb-4 text-white">{t.filters.category}</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to={`/${lang}/catalogue?category=cosmetic`} className="text-white/60 hover:text-gold-400 transition-colors">{t.categories.cosmetic}</Link></li>
              <li><Link to={`/${lang}/catalogue?category=perfume`} className="text-white/60 hover:text-gold-400 transition-colors">{t.categories.perfume}</Link></li>
              <li><Link to={`/${lang}/catalogue?category=aroma`} className="text-white/60 hover:text-gold-400 transition-colors">{t.categories.aroma}</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="font-medium mb-4 text-white">{t.nav.contact}</h4>
