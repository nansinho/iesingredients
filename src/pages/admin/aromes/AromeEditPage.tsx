  ...
  useEffect(() => {
    if (product) {
      form.reset({
        ...
        profil_aromatique: (product.profil_aromatique as string) || "",
        application: (product.application as string) || "",
        dosage: (product.dosage as string) || "",
        aspect: (product.aspect as string) || "",
        base: (product.base as string) || "",
        ph: (product.ph as string) || "",
        conservateurs: (product.conservateurs as string) || "",
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Propriétés techniques</CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Conservateurs</FormLabel>
                        <FormControl>
                          <Input {...field} value={field.value || ""} />
                        </FormControl>
                        <FormMessage />
          ...
          <div className="fixed bottom-16 left-0 right-0 p-4 bg-background lg:static lg:p-0 lg:bg-transparent">
            <Button
              type="submit"
