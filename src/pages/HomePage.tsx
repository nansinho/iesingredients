...
export const HomePage = ({ lang }: HomePageProps) => {
  ...
  return (
    <Layout lang={lang}>
      ...
      {/* CATEGORIES - Fond vert forêt */}
      <section className="py-24 md:py-32 bg-forest-950">
        <div className="container-luxe">
          {/* Section header - Titre professionnel sans italique */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {[
              { 
                ...
                color: 'hsl(var(--cosmetique-500))',
                iconBg: 'bg-cosmetique-500'
              },
              { 
                ...
                color: 'hsl(var(--parfum-500))',
                iconBg: 'bg-parfum-500'
              },
              { 
                ...
                <article className="relative h-[480px] md:h-[560px] rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-start">
                      <div className={`w-14 h-14 rounded-xl flex items-center justify-center shadow-lg ${cat.iconBg}`}>
                        <cat.icon className="w-7 h-7 text-white" />
                      </div>
                      <span className="px-4 py-2 rounded-xl backdrop-blur-sm text-white text-sm font-semibold uppercase tracking-wider border border-white/20 bg-white/10">
                        {cat.count}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <div className={`inline-flex items-center gap-3 px-5 py-2.5 rounded-xl text-white text-sm font-medium uppercase tracking-wider group-hover:gap-4 transition-all ${cat.iconBg}`}>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                {[
                  ...
                  >
                    <item.icon className="w-5 h-5 text-gold-600 shrink-0" />
                    <span className="text-foreground text-xs font-medium uppercase tracking-wider">{item.text}</span>
                  </div>
                ))}
              </div>

              <Link to={`/${lang}/entreprise`}>
                <Button variant="premium-solid" size="lg" className="group">
          ...
          <div className="container-luxe">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-12 md:mb-16">
              ...
              <Link to={`/${lang}/catalogue`}>
                <Button variant="premium-light-outline" size="lg" className="group">
      ...
      <section className="py-24 md:py-32 bg-background relative overflow-hidden">
        ...
        <div className="container-luxe relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-foreground mb-8">
              {lang === 'fr' ? 'Créons ensemble votre succès' : 'Let\'s create your success together'}
            </h2>
